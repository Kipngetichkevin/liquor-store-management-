            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $lowStockCount ?? 0 }}</p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $outOfStockCount ?? 0 }}</p>
                    </div>
                            ...
                            @foreach($products as $product)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                                        ...
                                        <div class="text-xs text-gray-500 dark:text-gray-400">{{ $product->sku ?? 'No SKU' }}</div>
                                    </td>
...
@endsection
'@ | Out-File -FilePath "resources/views/pages/products/index.blade.php" -Encoding UTF8 -Force