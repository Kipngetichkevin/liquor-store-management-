    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('products.show', $product->id) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                    View
                </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-500 text-sm mt-1">Stock Keeping Unit</p>
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="image" class="block text-gray-700 font-medium mb-2">New Product Image</label>
                            <input type="file" 
                                   id="image" 
                                   name="image"
                                   accept="image/*"
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   id="bottle_size" 
                                   name="bottle_size" 
                                   value="{{ old('bottle_size', $product->bottle_size) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
