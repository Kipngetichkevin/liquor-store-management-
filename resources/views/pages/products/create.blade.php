...
@section('title', 'Add Product - Liquor Management System')

@section('page-title', 'Add Product')
@section('page-subtitle', 'Create a new liquor product')
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="sku" id="sku" value="{{ old('sku', $sku ?? '') }}" 
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0" name="cost_price" id="cost_price" value="{{ old('cost_price') }}" 
                               class="w-full pl-12 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    @error('cost_price')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="number" min="0" name="min_stock_level" id="min_stock_level" value="{{ old('min_stock_level', 10) }}" 
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="number" step="0.1" min="0" max="100" name="alcohol_percentage" id="alcohol_percentage" value="{{ old('alcohol_percentage') }}" 
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="number" min="0" name="volume_ml" id="volume_ml" value="{{ old('volume_ml') }}" 
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
                           placeholder="e.g., 750">
                    @error('volume_ml')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
