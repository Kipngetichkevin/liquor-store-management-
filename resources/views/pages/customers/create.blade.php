...
@section('title', 'Add Customer - Liquor Management System')

@section('page-title', 'Add Customer')
@section('page-subtitle', 'Add a new customer to the system')
        ...
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="customer_code" id="customer_code" value="{{ old('customer_code', $customerCode) }}" 
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="country" id="country" value="{{ old('country', 'Kenya') }}" 
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="sms_opt_in" value="1" {{ old('sms_opt_in') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Receive SMS promotions</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="email_opt_in" value="1" {{ old('email_opt_in') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
