...
class ProductController extends Controller
{
    ...
    {
        // 👇 PERMISSION CHECK – admin, manager, stock keeper can view
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // 👇 ACTIVITY LOG
            auth()->user()->logActivity('create', 'products', 'Created product: ' . $product->name);
    ...
    {
        // 👇 PERMISSION CHECK
        $check = $this->checkRole(['admin', 'manager', 'stock_keeper', 'cashier']);
        if ($check !== true) return $check;
    ...
    public function update(Request $request, Product $product)
    {
        ...
        try {
            ...
            // 👇 ACTIVITY LOG
            auth()->user()->logActivity('update', 'products', 'Updated product: ' . $product->name);
    ...
    public function destroy(Product $product)
    {
        ...
        try {
            ...
            // 👇 ACTIVITY LOG
            auth()->user()->logActivity('delete', 'products', 'Deleted product: ' . $productName);
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        try {
            ...
            // 👇 ACTIVITY LOG (optional – can log count)
            auth()->user()->logActivity('delete', 'products', 'Bulk deleted ' . count($request->ids) . ' products');
    ...
    {
        // 👇 PERMISSION CHECK – admin, manager, stock keeper can adjust stock
        $check = $this->checkRole(['admin', 'manager', 'stock_keeper']);
        if ($check !== true) return $check;
        ...
        try {
            ...
            // 👇 ACTIVITY LOG
            auth()->user()->logActivity('update', 'products', 
                'Adjusted stock for ' . $product->name . ': ' . $oldStock . ' → ' . $request->stock_quantity);
